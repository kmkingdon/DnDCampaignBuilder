...
import { createAbilityObject, getCharacterSubTraits, getCharacterTraits, selectCharacters, updateCharacterParam } from '@/state/config.slice';
...
export default function Race() {
    ...
    if(selectedData === null){
      ...
      useEffect(() => {
        ...
        // ability bonus
        useEffect(()=> {
            if(!isLoadingRace && raceData){
                const bonus = raceData.ability_bonuses;
                dispatch(createAbilityObject({id:key, bonus}))
            }
        }, [isLoadingRace, raceData])
                        ...
                        <>
                            <div className="pt-2">
                                ...
                                <div className="flex flex-row  justify-around">
                                    ...
                                    <Tooltip content={alignmentDesc?.desc || 'Select an alignment to see more details.'} style="light" theme={{ style: {light:"w-40 border border-gray-200 bg-white text-gray-900"}  }}>
                                                ...
                                                </Tooltip>
                                                {
                                                    ...
                                                    <div className="pt-2">
                                                        <div className="flex flex-row  justify-around">
                                                            ...
                                                            <Tooltip content={i.index in subTraitDescParam  ? JSON.stringify(subTraitDescParam[i.index]) : 'Select a subtrait'} style="light" theme={{ style: {light:"w-100 border border-gray-200 bg-white text-gray-900"}  }}>
                                                                <div className="w-full h-full flex justify-center items-center">
                                                                    <MdInfoOutline size="25" color="white"/>
                                                                </div>
                                                            </Tooltip>
